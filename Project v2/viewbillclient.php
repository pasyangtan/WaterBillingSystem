...
<h4>Note: Bill Amount = Total Consumption * Price/unit Also Includes Tax.&copy;</h4>
<?php
include 'db.php';
$id =$_REQUEST['id'];
...
while($row = mysqli_fetch_array($result))
  ...
  echo "<td>" . $price . "</td>";
  echo "<td>" . $row['date'] . "</td>";
 echo "<td><a rel='facebox' href='viewpayclient.php?id=".$row['id']."'><span class=\"glyphicon glyphicon-eye-open\">View </a> ";
  echo "</tr>";
  }
echo "</table>";
