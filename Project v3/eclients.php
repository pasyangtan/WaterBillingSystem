...
<div id="wrapper">
  ...
  <ul class="nav nav-pills">
    ...
    <li class="btn btn-default btn-xs"><a href="eclients.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Clients</a></li>
  </ul>
  <hr color="#999999" />
    ...
    <!-------- home panel ----------------------------->
         ...
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5>System Clients</h5><a rel='facebox' href="eaddclient.php" ><button type="button" class="btn btn-primary btn-xs">Add Client</button></a></div>
            </div>
...
while($row = mysqli_fetch_array($result))
 ...
 echo "<td><a rel='facebox' href='empedit.php?id=".$row['id']."'><button class=\"btn btn-default btn-xs\"><span class=\"glyphicon glyphicon-edit\"></span></button> </a>| ";
 echo "<a rel='facebox' href='edel.php?id=".$row['id']."'><button class=\"btn btn-danger btn-xs\"><span class=\"glyphicon glyphicon-trash \"></span></button></td>";
  echo "</tr>";
  }
echo "</table>";
