...
<body>
    ...
    <div class="topnav">
        ...
        <a class="active" href="http://localhost/wbs/Tips.php">Tips</a>
    ...
    <div class="row">
        ...
        <div class="tips">
            <h3> Some Tips</h3>
            <p class="one">1. Don’t play too much with water in the summer.<br>
                2. When you drink water from a glass only take as much as you need.<br>
                3. Shut off the water while you are rinsing the dishes.<br>
                4. Fix your leaks. Eg: Check for leaks in faucets or pipes.<br>
                5. Close tap while not in use.</p>
        </div>
    </div>
