...
<tr><td bordercolor="#000000">Consuption: </td><td><b><i><?php echo $totalcons;?> </td>

</tr>
<tr><td colspan="4"><center><h2>Total Invoice:<b><i> Rs.<?php echo $price; ?><b><i> </h2></center></td></tr>
<?php
$session=$_SESSION['id'];
include 'db.php';
...
while($row = mysqli_fetch_array($result))
  ...
  $space = ' ';
?>
<tr><td>Casher:<?php echo $sessionfname; echo $space; echo $sessionlname;?></td><td>Signature:_____________</td></tr>
...
class=" glyphicon glyphicon-print"></span>&nbsp;Print Bill</button>&nbsp;<a href="clienthome.php"><button class="btn btn-danger"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Go back</button></a></CENTER>
</body>
</html>