...
class=" glyphicon glyphicon-print"></span>&nbsp;Print Bill</button>&nbsp;<a href="viewbillclient.php"><button class="btn btn-danger"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Go back</button></a></CENTER>
</body>
</html>