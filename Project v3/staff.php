...
<a href="billing.php"><span ></span><img id="logo" src="http://localhost/wbs/img/Logo.png"></a>
<body>
<div class="container">
<div id="wrapper">
    ...
    <!-------- home panel ----------------------------->
         ...
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5>System Staffs</h5><a rel='facebox' href="empuser.php" ><button type="button" class="btn btn-primary btn-xs">Add Staff</button></a></div>
            </div>
...
while($row = mysqli_fetch_array($result))
 ...
 echo "<td><a rel='facebox' href='empeditadmin.php?id=".$row['id']."'><button class=\"btn btn-default btn-xs\"><span class=\"glyphicon glyphicon-edit\"></span></button></a>| ";
