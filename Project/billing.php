...
<div id="wrapper">
  ...
  <ul class="nav nav-pills">
    ...
    <li><a href="user.php"><span class="glyphicon glyphicon-user"></span>&nbsp;Employee</a></li>
    <li><a href="clients.php"><span class="glyphicon glyphicon-list"></span>&nbsp;Customer</a></li>
  </ul>
<hr color="#999999" />
  <div class="tab-content">
      ...
      <div class="col-md-4">
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5 style="font-size:24px; font-weight:bold;">Customer</h5></div>
            </div>
   ...
   <!-----  ######################################### -->
    <div class="col-md-4">
         <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title"><h5 style="font-size:24px; font-weight:bold;">Employee</h5></div>
            </div>
              <div class="panel-body">
