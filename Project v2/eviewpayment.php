...
<tr><td colspan="4"><center><h2>Total Invoice:<b><i> <?php echo $price; ?><b><i> /= Tshs</h2></center></td></tr>
<?php
$session=$_SESSION['id'];
include 'db.php';
...
class=" glyphicon glyphicon-print"></span>&nbsp;Print Bill</button>&nbsp;<a href="empbill.php"><button class="btn btn-danger"><span class="glyphicon glyphicon-arrow-left"></span>&nbsp;Go back</button></a></CENTER>
</body>
</html>