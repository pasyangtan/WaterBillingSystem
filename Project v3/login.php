...
<body>
    ...
    <div class="topnav">
        ...
        <a class="active" href="http://localhost/wbs/login.php">Login</a>
    ...
    <div class="row">
        ...
        <div class="login">
        <form method="get" action="clientlogin.php">
            <input type="submit" value="Client Login">
</form>
<form method="get" action="emplogin.php">
            <input type="submit" value="Staff Login">
</form>
            <h4 style="font-size:30px;"> Log in to your account</h4>
            <form id="details" action="process.php" method="post">
                <label>Username</label>
                <input type="text" id="username" name="username" required>
                <label>Password</label>
                <input type="password" id="pass" name="password" required>
                <p class="test" ><a href="http://localhost/wbs/forgotpass.php" > ForgotPassword?</a></p>
