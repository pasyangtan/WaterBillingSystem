...
<div id="wrapper">
  ...
  <ul class="nav nav-pills">
    ...
    <li class="btn btn-default btn-xs"><a href="empbill.php"><span class="glyphicon glyphicon-usd"></span>&nbsp;Billing</a></li>
...
while($row = mysqli_fetch_array($result))
 ...
 echo "<td><a rel='facebox' href='epaybill.php?id=".$row['id']."'><span class=\"btn btn-info btn-xs glyphicon glyphicon-usd\">Run</span> </a>| ";
 echo "<a rel='facebox' href='eviewbill.php?id=".$row['id']."'><span class=\"btn btn-danger  btn-xs glyphicon glyphicon-eye-open\">View</span></td>";
  echo "</tr>";
  }
echo "</table>";
